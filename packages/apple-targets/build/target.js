...
exports.getWatchAppTarget = exports.getAuxiliaryTargets = exports.getMainAppTarget = exports.isNativeTargetOfType = exports.getFrameworksForType = exports.needsEmbeddedSwift = exports.productTypeForType = exports.getTargetInfoPlistForType = exports.SHOULD_USE_APP_GROUPS_BY_DEFAULT = exports.KNOWN_EXTENSION_POINT_IDENTIFIERS = void 0;
...
function isNativeTargetOfType(target, type) {
    ...
    if ((type === "watch-widget" || type === "widget") &&
        target.props.productType === "com.apple.product-type.app-extension") {
        return ("WATCHOS_DEPLOYMENT_TARGET" in
            target.getDefaultConfiguration().props.buildSettings) && type === "watch-widget";
    }
    if (type === "clip" &&
...
function getWatchAppTarget(project) {
...
exports.getWatchAppTarget = getWatchAppTarget;
